...
public abstract class AbstractConnection implements Connection {
    ...
    @Override
    public final void send(final byte[] raw) {
        send(new Sender() {
            @Override
    ...
    /**
     * Sends an sender to the sentry server.
     *
     * @param sender captured sender to add in Sentry.
     * @throws ConnectionException whenever a temporary exception due to the connection happened.
     */
    protected abstract void doSend(Sender sender) throws ConnectionException;
